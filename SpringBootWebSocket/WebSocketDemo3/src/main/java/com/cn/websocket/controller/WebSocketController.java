...
import com.cn.websocket.entity.Client2ServerMessage;
import com.cn.websocket.entity.Server2ClientMessage;
...
public class WebSocketController {
    ...
    @SendTo("/topic") //如果服务器接受到了消息，就会对订阅了 @SendTo 括号中的地址的浏览器发送消息。
