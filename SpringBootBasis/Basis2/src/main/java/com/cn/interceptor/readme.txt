Interceptor实现步骤
1.XXXInterceptor  实现  HandlerInterceptor接口

2.XXXConfiguration 继承 WebMvcConfigurerAdapter  + @Configuration
并且 重写  addInterceptors 方法
...
Struts2中调用ActionInvocation的invoke方法就是调用下一个Interceptor 或者是调用action，
